...
type MetricsClient interface {
	UpdateMetrics(ctx context.Context, in *AddMetricsRequest, opts ...grpc.CallOption) (*AddMetricsResponse, error)
}
...
func (c *metricsClient) UpdateMetrics(ctx context.Context, in *AddMetricsRequest, opts ...grpc.CallOption) (*AddMetricsResponse, error) {
...
type MetricsServer interface {
	UpdateMetrics(context.Context, *AddMetricsRequest) (*AddMetricsResponse, error)
...
func (UnimplementedMetricsServer) UpdateMetrics(context.Context, *AddMetricsRequest) (*AddMetricsResponse, error) {
...
func _Metrics_UpdateMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServer).UpdateMetrics(ctx, req.(*AddMetricsRequest))
	}
